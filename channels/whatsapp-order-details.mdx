...
<Frame caption="Los dos pasos en el Constructor de Flujos, cada uno con rama 'If send WhatsApp failed'">
  <img src="/images/channels/whatsapp-order-details-1.png" alt="Los dos pasos en el Constructor de Flujos, cada uno con rama 'If send WhatsApp failed'" />
</Frame>
...
<Frame caption="Creación de una plantilla de Order Details">
  <img src="/images/channels/whatsapp-order-details-2.png" alt="Creación de una plantilla de Order Details" />
</Frame>
...
<Frame caption="Ejemplo del mensaje Order Details con opciones de pago">
  <img src="/images/channels/whatsapp-order-details-3.png" alt="Ejemplo del mensaje Order Details con opciones de pago" />
</Frame>
