...
<Frame caption="Configuración de una Petición externa: tipo, URL y parámetros">
  <img src="/images/flow-builder/external-request-1.png" alt="Configuración de una Petición externa: tipo, URL y parámetros" />
</Frame>
...
<Frame caption="Respuesta de la petición con código de estado y mapeo de JSON path">
  <img src="/images/flow-builder/external-request-2.png" alt="Respuesta de la petición con código de estado y mapeo de JSON path" />
</Frame>
