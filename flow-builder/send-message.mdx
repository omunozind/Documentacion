...
<Frame caption="Selector de tipo de mensaje al enviar un mensaje">
  <img src="/images/flow-builder/send-message-1.png" alt="Selector de tipo de mensaje al enviar un mensaje" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Insertar campos personalizados y emojis" icon="face-smile">
    ...
    <Frame caption="Buscador de campos personalizados y emojis dentro del editor de texto">
      <img src="/images/flow-builder/send-message-2.png" alt="Buscador de campos personalizados y emojis dentro del editor de texto" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Imagen, audio, video y archivo" icon="paperclip">
    ...
    <Frame caption="Las 4 formas de adjuntar contenido multimedia">
      <img src="/images/flow-builder/send-message-3.png" alt="Las 4 formas de adjuntar contenido multimedia" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Tarjeta (Card)" icon="id-card">
    ...
    <Frame caption="Editor de tarjeta: imagen, título, subtítulo y botón">
      <img src="/images/flow-builder/send-message-4.png" alt="Editor de tarjeta: imagen, título, subtítulo y botón" />
    </Frame>
  </Accordion>
  ...
  <Accordion title='Bucle "Para cada uno" (For Each)' icon="repeat">
    ...
    **Botón dentro de "Para cada uno":** si le agregas un botón, aparece en cada tarjeta generada. Cuando el usuario elige una, el dato de esa tarjeta específica queda disponible en un campo especial llamado **SELECT**.
    ...
    <Frame caption='Configuración del bucle "Para cada uno" seleccionando la variable JSON e ITEM'>
      <img src="/images/flow-builder/send-message-5.png" alt="Configuración del bucle 'Para cada uno' seleccionando la variable JSON e ITEM" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Contenido dinámico" icon="server">
    ...
    <Frame caption="Configuración de una solicitud de Contenido dinámico">
      <img src="/images/flow-builder/send-message-6.png" alt="Configuración de una solicitud de Contenido dinámico" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Ubicación" icon="location-dot">
    ...
    <Frame caption="Selector de ubicación en el mapa">
      <img src="/images/flow-builder/send-message-7.png" alt="Selector de ubicación en el mapa" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Texto de depuración (Debug)" icon="bug">
    ...
    <Frame caption="Agregar un tester y enviar un texto de depuración">
      <img src="/images/flow-builder/send-message-8.png" alt="Agregar un tester y enviar un texto de depuración" />
    </Frame>
  </Accordion>
</AccordionGroup>
...
<Tabs>
  <Tab title="Facebook">
    ...
    <Frame caption="Mensaje de Facebook con botones y quick replies configurados">
      <img src="/images/flow-builder/send-message-9.png" alt="Mensaje de Facebook con botones y quick replies configurados" />
    </Frame>
  ...
  <Tab title="WeChat">
    ...
    <Frame caption="Editor de Artículo de WeChat">
      <img src="/images/flow-builder/send-message-10.png" alt="Editor de Artículo de WeChat" />
    </Frame>

    <Frame caption="Configuración de Mini Programa de WeChat">
      <img src="/images/flow-builder/send-message-11.png" alt="Configuración de Mini Programa de WeChat" />
    </Frame>
  </Tab>
    ...
    <AccordionGroup>
      <Accordion title="Plantilla (Template Message)">
        ...
        <Frame caption="Selector de plantilla de WhatsApp dentro del nodo de mensaje">
          <img src="/images/flow-builder/send-message-12.png" alt="Selector de plantilla de WhatsApp dentro del nodo de mensaje" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Producto único">
        ...
        <Frame caption="Configuración de mensaje de Producto único">
          <img src="/images/flow-builder/send-message-13.png" alt="Configuración de mensaje de Producto único" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Múltiples productos">
        ...
        <Frame caption="Configuración de mensaje de Múltiples productos">
          <img src="/images/flow-builder/send-message-14.png" alt="Configuración de mensaje de Múltiples productos" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Mensaje de catálogo">
        ...
        <Frame caption="Configuración de Mensaje de catálogo">
          <img src="/images/flow-builder/send-message-15.png" alt="Configuración de Mensaje de catálogo" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Mensaje de lista">
        ...
        <Frame caption="Configuración de Mensaje de lista y sus opciones">
          <img src="/images/flow-builder/send-message-16.png" alt="Configuración de Mensaje de lista y sus opciones" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="WhatsApp Flow">
        ...
        <Frame caption="Selector de WhatsApp Flow dentro del nodo de mensaje">
          <img src="/images/flow-builder/send-message-17.png" alt="Selector de WhatsApp Flow dentro del nodo de mensaje" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Contacto (WhatsApp Contact)">
        ...
        <Frame caption="Configuración de tarjeta de Contacto">
          <img src="/images/flow-builder/send-message-18.png" alt="Configuración de tarjeta de Contacto" />
        </Frame>
      </Accordion>
