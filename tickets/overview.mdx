...
description: "El CRM avanzado de Botky: crea listas de incidencias, personalízalas con campos propios y gestiónalas desde el chat en vivo, el Flow Builder o mediante disparadores."
icon: "ticket"
---

**Tickets** es el **CRM más avanzado** dentro de Botky. Si ya conoces los [**Tableros**](/boards/overview) — nuestro CRM visual tipo Trello, simple y directo — Tickets es la versión con más potencia: campos completamente personalizables, múltiples vistas, permisos por rol, disparadores automáticos y una API propia para integrarlo con tus flujos.
...
Para estos casos, Botky incluye el complemento **Tickets**. Con Tickets puedes crear listas de incidencias y asignarlas a los usuarios, funcionando como un sistema de CRM interno completo.

<Frame caption="Playlist de tutoriales de Tickets">
  Video pendiente
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-1.png" alt="overview" />
</Frame>

Haz clic en el botón **"\+List"** para crear una nueva lista.

<Frame>
  <img src="/images/tickets/overview-2.png" alt="overview" />
</Frame>

Una vez completado, haz clic en el botón **create**.

<Frame>
  <img src="/images/tickets/overview-3.png" alt="overview" />
</Frame>

### Vistas (Views)

<Frame>
  <img src="/images/tickets/overview-4.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-5.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-6.png" alt="overview" />
</Frame>

También puedes crear una nueva vista y cambiar la respuesta según el resultado que desees.

<Frame>
  <img src="/images/tickets/overview-7.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-8.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-9.png" alt="overview" />
</Frame>
...
<Steps>
  ...
  <Step title="Selecciona tu proyecto y vista">
    ...
    <Frame>
      <img src="/images/tickets/overview-10.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Edita la configuración de la vista">
    ...
    <Frame>
      <img src="/images/tickets/overview-11.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Elige el diseño del gráfico (layout)">
    ...
    <Frame>
      <img src="/images/tickets/overview-12.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Configura la agrupación (opcional)">
    ...
    <Frame>
      <img src="/images/tickets/overview-13.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Define un título personalizado">
    ...
    <Frame>
      <img src="/images/tickets/overview-14.png" alt="overview" />
    </Frame>
  </Step>
  ...
  <Step title="Verifica el título del gráfico configurado">
    ...
    <Frame>
      <img src="/images/tickets/overview-15.png" alt="overview" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Ve a la lista de tickets">
    <Frame>
      <img src="/images/tickets/overview-16.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Selecciona Edit View">
    <Frame>
      <img src="/images/tickets/overview-17.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="En el campo Group By, elige Agent Type o Rating Type">
    <Frame>
      <img src="/images/tickets/overview-18.png" alt="overview" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/tickets/overview-19.png" alt="overview" />
</Frame>

**Ejemplo visual de la vista Table agrupada por agentes:**

<Frame>
  <img src="/images/tickets/overview-20.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-21.png" alt="overview" />
</Frame>

Ahora, con la vista "All Items" oculta, el admin designado ya no verá una lista completa de tickets.

<Frame>
  <img src="/images/tickets/overview-22.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-23.png" alt="overview" />
</Frame>

Ahora, con la vista "Not Done" oculta, el admin ya no ve ningún ticket incompleto.

<Frame>
  <img src="/images/tickets/overview-24.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-25.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-26.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-27.png" alt="overview" />
</Frame>

Para los CUF de tipo Select, puedes agregar una lista desplegable de opciones a elegir.

<Frame>
  <img src="/images/tickets/overview-28.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-33.png" alt="overview" />
</Frame>

<Frame>
  <img src="/images/tickets/overview-34.png" alt="overview" />
</Frame>
...
<Frame>
  <img src="/images/tickets/overview-35.png" alt="overview" />
</Frame>

Las siguientes acciones están disponibles:

<Frame>
  <img src="/images/tickets/overview-36.png" alt="overview" />
</Frame>
...
<Steps>
  <Step title="Lists">
    ...
    <Frame>
      <img src="/images/tickets/overview-37.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="List Tickets">
    ...
    <Frame>
      <img src="/images/tickets/overview-38.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="List Field Options">
    ...
    <Frame>
      <img src="/images/tickets/overview-39.png" alt="overview" />
    </Frame>

    <Frame>
      <img src="/images/tickets/overview-40.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Create Ticket">
    ...
    <Frame>
      <img src="/images/tickets/overview-41.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Update Ticket">
    ...
    <Frame>
      <img src="/images/tickets/overview-42.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Get Ticket">
    ...
    <Frame>
      <img src="/images/tickets/overview-43.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Delete Ticket">
    ...
    <Frame>
      <img src="/images/tickets/overview-44.png" alt="overview" />
    </Frame>
  </Step>
  <Step title="Add Comment">
    ...
    <Frame>
      <img src="/images/tickets/overview-45.png" alt="overview" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/tickets/overview-46.png" alt="overview" />
</Frame>

<Frame>
  <img src="/images/tickets/overview-47.png" alt="overview" />
</Frame>
...
<Frame caption="API de Tickets">
  Video pendiente
</Frame>

El **sistema de Tickets** de Botky es una función clave que simplifica la gestión de soporte y tareas. Con la **API de Tickets** puedes gestionar las consultas de los clientes o las actualizaciones de tareas directamente dentro del Constructor de Flujos. Ya sea que estés atendiendo solicitudes de soporte o resolviendo incidencias, el sistema de tickets de Botky garantiza una experiencia fluida.
...
El precio del complemento: **Comunícate con soporte**.
...
<Frame>
  <img src="/images/tickets/overview-48.png" alt="overview" />
</Frame>
