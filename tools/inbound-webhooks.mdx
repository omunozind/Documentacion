...
<Frame caption="Webhooks entrantes">
  <img src="/images/tools/inbound-webhooks-1.png" alt="Webhooks entrantes" />
</Frame>
...
<Frame caption="Sección Webhooks entrantes en Herramientas">
  <img src="/images/tools/inbound-webhooks-2.png" alt="Sección Webhooks entrantes en Herramientas" />
</Frame>

Haz clic en **New Inbound Webhook**, dale un nombre y haz clic en **Save**.

<Frame caption="Crear un nuevo webhook entrante">
  <img src="/images/tools/inbound-webhooks-3.png" alt="Crear un nuevo webhook entrante" />
</Frame>

Verás la interfaz de edición:

<Frame caption="Interfaz de edición del webhook entrante">
  <img src="/images/tools/inbound-webhooks-4.png" alt="Interfaz de edición del webhook entrante" />
</Frame>
...
<Frame caption="Registros del webhook entrante">
  <img src="/images/tools/inbound-webhooks-5.png" alt="Registros del webhook entrante" />
</Frame>
...
<Frame caption="Límite de peticiones del webhook entrante">
  <img src="/images/tools/inbound-webhooks-6.png" alt="Límite de peticiones del webhook entrante" />
</Frame>
...
| 1000/día | Comunícate con soporte | ~30K peticiones/mes |
| 2000/día | Comunícate con soporte | ~60K peticiones/mes |
| 3000/día | Comunícate con soporte | ~90K peticiones/mes |
| 4000/día | Comunícate con soporte | ~120K peticiones/mes |
| 5000/día | Comunícate con soporte | ~150K peticiones/mes |
| 10000/día | Comunícate con soporte | ~300K peticiones/mes |
...
<Frame caption="Header con rate-limit-remaining">
  <img src="/images/tools/inbound-webhooks-7.png" alt="Header con rate-limit-remaining" />
</Frame>
...
<Frame caption="Edición del webhook y solicitud externa en paralelo">
  <img src="/images/tools/inbound-webhooks-8.png" alt="Edición del webhook y solicitud externa en paralelo" />
</Frame>

Sigue los pasos 1 a 8 de la captura:

<Frame caption="Pasos 1 a 8 de la prueba">
  <img src="/images/tools/inbound-webhooks-9.png" alt="Pasos 1 a 8 de la prueba" />
</Frame>
...
<Frame caption="Datos guardados tras el test">
  <img src="/images/tools/inbound-webhooks-10.png" alt="Datos guardados tras el test" />
</Frame>
...
<Frame caption="Indicar phone y email en el JSON">
  <img src="/images/tools/inbound-webhooks-11.png" alt="Indicar phone y email en el JSON" />
</Frame>

Finalmente, mapea el resto de los datos al chatbot:

<Frame caption="Mapeo del resto de los datos">
  <img src="/images/tools/inbound-webhooks-12.png" alt="Mapeo del resto de los datos" />
</Frame>

**Guarda** la edición de tu webhook entrante:

<Frame caption="Guardar el webhook entrante">
  <img src="/images/tools/inbound-webhooks-13.png" alt="Guardar el webhook entrante" />
</Frame>

Entra al subflujo y enviémosle un mensaje al usuario del bot:

<Frame caption="Enviar un mensaje al usuario en el subflujo">
  <img src="/images/tools/inbound-webhooks-14.png" alt="Enviar un mensaje al usuario en el subflujo" />
</Frame>
...
<Frame caption="Prueba en vivo tras publicar">
  <img src="/images/tools/inbound-webhooks-15.png" alt="Prueba en vivo tras publicar" />
</Frame>
...
<Frame caption="Nuevo perfil de usuario creado, visto del lado del usuario">
  <img src="/images/tools/inbound-webhooks-16.png" alt="Nuevo perfil de usuario creado, visto del lado del usuario" />
</Frame>
...
<Frame caption="Desactivar Bot Fight Mode en Cloudflare">
  <img src="/images/tools/inbound-webhooks-17.png" alt="Desactivar Bot Fight Mode en Cloudflare" />
</Frame>
