...
Con el **widget de Chat web** puedes agregar un chatbot a cualquier sitio web sin depender de otro canal. Esto te ayuda a aprovechar el poder del marketing conversacional sin las desventajas o restricciones que otros canales podrían tener.

## Cómo acceder al widget de Chat web
...
Después de crearlo, encontrarás el **widget de Chat web** en la barra lateral izquierda.

<Frame caption="Widget de Chat web en la barra lateral">
  <Placeholder />
</Frame>
...
El widget de Chat web te permite redirigir a los usuarios a múltiples plataformas como WhatsApp, Facebook Messenger, Instagram, Telegram y más, para que se conecten contigo por su canal preferido.
...
<Card type="note">
  Para una misma web, puedes instalar **distintos estilos** de Chat web en distintas páginas. Video de referencia: [youtube.com/watch?v=Jrcb-y9fw3E](https://www.youtube.com/watch?v=Jrcb-y9fw3E)
</Card>
...
Hay muchas personalizaciones avanzadas que puedes hacer con el botón de Chat web.
...
<Steps>
  ...
  <Step title="Agrega el ref al código de instalación">
    En tu script de instalación del Chat web, agrega un signo de interrogación después de `.js`, luego `ref=` y pega el parámetro ref que copiaste. Esto **sobrescribe** el flujo de inicio por defecto y permite iniciar el flujo que prefieras.
...
#### Pre-rellenar los datos del usuario del Chat web
...
<Frame caption="Parámetros extra pasados al usuario del Chat web">
  <Placeholder />
</Frame>

## Preguntas frecuentes

- ¿Puedo cambiar el pie (footer) del widget de Chat web?
- ¿Se puede abrir el widget de Chat web por defecto sin hacer clic en el botón?
