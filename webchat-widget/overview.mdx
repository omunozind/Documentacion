...
<Frame caption="Botón Set up omni channel">
  <img src="/images/webchat-widget/overview-1.png" alt="Botón Set up omni channel" />
</Frame>
...
<Frame caption="Creación del Omnicanal">
  <img src="/images/webchat-widget/overview-2.png" alt="Creación del Omnicanal" />
</Frame>

Después de crearlo, encontrarás el **widget web** en la barra lateral izquierda.

<Frame caption="Widget web en la barra lateral">
  <img src="/images/webchat-widget/overview-3.png" alt="Widget web en la barra lateral" />
</Frame>
...
<Frame caption="Vista general de ajustes del widget">
  <img src="/images/webchat-widget/overview-4.png" alt="Vista general de ajustes del widget" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Chat Bubble" icon="comment">
    ...
    <Frame caption="Selección del ícono de burbuja">
      <img src="/images/webchat-widget/overview-5.png" alt="Selección del ícono de burbuja" />
    </Frame>
  </Accordion>
  <Accordion title="Chat Footer" icon="shoe-prints">
    ...
    <Frame caption="Configuración del pie del widget">
      <img src="/images/webchat-widget/overview-6.png" alt="Configuración del pie del widget" />
    </Frame>
  </Accordion>
  <Accordion title="Conversation button" icon="hand-pointer">
    ...
    <Frame caption="Botones de conversación (CTA)">
      <img src="/images/webchat-widget/overview-7.png" alt="Botones de conversación (CTA)" />
    </Frame>
  </Accordion>
  <Accordion title="Welcome message" icon="hand-wave">
    ...
    <Frame caption="Mensaje de bienvenida del widget">
      <img src="/images/webchat-widget/overview-8.png" alt="Mensaje de bienvenida del widget" />
    </Frame>
  </Accordion>
  <Accordion title="Out of office message" icon="clock">
    ...
    <Frame caption="Mensaje de fuera de oficina">
      <img src="/images/webchat-widget/overview-9.png" alt="Mensaje de fuera de oficina" />
    </Frame>
  </Accordion>
</AccordionGroup>
...
<Steps>
  ...
  <Step title="Agrega campos">
    ...
    <Frame caption="Tipos de campo del formulario previo">
      <img src="/images/webchat-widget/overview-10.png" alt="Tipos de campo del formulario previo" />
    </Frame>
  </Step>
  <Step title="Edita cada campo">
    ...
    <Frame caption="Edición de un campo del formulario">
      <img src="/images/webchat-widget/overview-11.png" alt="Edición de un campo del formulario" />
    </Frame>
  </Step>
  <Step title="Mensaje previo (opcional)">
    ...
    <Frame caption="Opción de mensaje previo del usuario">
      <img src="/images/webchat-widget/overview-12.png" alt="Opción de mensaje previo del usuario" />
    </Frame>
  </Step>
</Steps>
...
<Frame caption="Selección del flujo de inicio por defecto">
  <img src="/images/webchat-widget/overview-13.png" alt="Selección del flujo de inicio por defecto" />
</Frame>
...
<Frame caption="Ajustes de canales conectados">
  <img src="/images/webchat-widget/overview-14.png" alt="Ajustes de canales conectados" />
</Frame>
...
<Frame caption="Configuración de mensajes de saludo por página">
  <img src="/images/webchat-widget/overview-15.png" alt="Configuración de mensajes de saludo por página" />
</Frame>
...
<Frame caption="Pestaña Settings del widget">
  <img src="/images/webchat-widget/overview-16.png" alt="Pestaña Settings del widget" />
</Frame>
...
<Steps>
  ...
  <Step title="Ubica la opción Channels">
    ...
    <Frame caption="Opción Channels en los ajustes">
      <img src="/images/webchat-widget/overview-17.png" alt="Opción Channels en los ajustes" />
    </Frame>
  </Step>
  <Step title="Activa los canales deseados">
    ...
    <Frame caption="Canales activados en el widget">
      <img src="/images/webchat-widget/overview-18.png" alt="Canales activados en el widget" />
    </Frame>
  </Step>
</Steps>
...
<Frame caption="Pestaña de Apariencia">
  <img src="/images/webchat-widget/overview-19.png" alt="Pestaña de Apariencia" />
</Frame>
...
<Frame caption="Opciones de Display Style">
  <img src="/images/webchat-widget/overview-20.png" alt="Opciones de Display Style" />
</Frame>
...
<Card type="note">
  Para una misma web, puedes instalar **distintos estilos** de widget en distintas páginas. Video pendiente
</Card>
...
<Frame caption="Pestaña Design (ejemplo con Embed Chat Window)">
  <img src="/images/webchat-widget/overview-21.png" alt="Pestaña Design (ejemplo con Embed Chat Window)" />
</Frame>
...
<Frame caption="Código de instalación del widget">
  <img src="/images/webchat-widget/overview-22.png" alt="Código de instalación del widget" />
</Frame>
...
<Frame caption="Configuración de Set Custom User ID">
  <img src="/images/webchat-widget/overview-23.png" alt="Configuración de Set Custom User ID" />
</Frame>
...
<Frame caption="Snippet de Custom User ID en el sitio">
  <img src="/images/webchat-widget/overview-24.png" alt="Snippet de Custom User ID en el sitio" />
</Frame>
...
<Steps>
  <Step title="Crea tu ref URL">
    ...
    <Frame caption="Creación de un ref URL en Herramientas">
      <img src="/images/webchat-widget/overview-25.png" alt="Creación de un ref URL en Herramientas" />
    </Frame>
  </Step>
  <Step title="Agrega el ref al código de instalación">
    ...
    <Frame caption="Agregar el parámetro ref al script de instalación">
      <img src="/images/webchat-widget/overview-26.png" alt="Agregar el parámetro ref al script de instalación" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Vuelve al ref URL">
    ...
    <Frame caption="Agregar payloads al ref URL">
      <img src="/images/webchat-widget/overview-27.png" alt="Agregar payloads al ref URL" />
    </Frame>
  </Step>
  ...
  <Step title="Agrega el valor en el script">
    ...
    <Frame caption="Payload agregado al perfil del usuario">
      <img src="/images/webchat-widget/overview-28.png" alt="Payload agregado al perfil del usuario" />
    </Frame>
  </Step>
</Steps>
...
<Frame caption="Parámetros extra pasados al usuario">
  <img src="/images/webchat-widget/overview-29.png" alt="Parámetros extra pasados al usuario" />
</Frame>
